...
#This script is used to trip videos from given time
...
# avi_name=va_path+'yrIXBklJ5YQ.mp4'

# with VideoFileClip(avi_name) as video:
#     end= 17.0648526077#video.duration
#     start=0.248072562358
...
for full_path in file_names_array:
    ...
    if important_l==2:
        im_name=full_path.split('/')[9].split('.')[0].split('_')[0]
      
    elif important_l==3:
        im_name1=full_path.split('/')[9].split('.')[0].split('_')[0]
        im_name2=full_path.split('/')[9].split('.')[0].split('_')[1]
        im_name=im_name1+'_'+im_name2
      
    elif important_l==4:
        im_name1=full_path.split('/')[9].split('.')[0].split('_')[0]
        im_name2=full_path.split('/')[9].split('.')[0].split('_')[1]
        im_name3=full_path.split('/')[9].split('.')[0].split('_')[2]
        im_name=im_name1+'_'+im_name2+'_'+im_name3
        ...
        im_name2=full_path.split('/')[9].split('.')[0].split('_')[1]
        im_name3=full_path.split('/')[9].split('.')[0].split('_')[2]
        im_name4=full_path.split('/')[9].split('.')[0].split('_')[3]
        im_name=im_name1+'_'+im_name2+'_'+im_name3+'_'+im_name4
        ...
        im_name3=full_path.split('/')[9].split('.')[0].split('_')[2]
        im_name4=full_path.split('/')[9].split('.')[0].split('_')[3]
        im_name5=full_path.split('/')[9].split('.')[0].split('_')[4]
        im_name=im_name1+'_'+im_name2+'_'+im_name3+'_'+im_name4+'_'+im_name5
        ...
        im_name4=full_path.split('/')[9].split('.')[0].split('_')[3]
        im_name5=full_path.split('/')[9].split('.')[0].split('_')[4]
        im_name6=full_path.split('/')[9].split('.')[0].split('_')[5]
        im_name=im_name1+'_'+im_name2+'_'+im_name3+'_'+im_name4+'_'+im_name5+'_'+im_name6
    

    already_cropped.append(im_name)
...
unq_list_cropped=[]#list (set (already_cropped))

for my_el in already_cropped:
    if not my_el in unq_list_cropped:
        unq_list_cropped.append(my_el)
    ...
    with open(SDK_l_path+file_name+'.csv') as f:
        ...
        for row in cf:
            if row[0]=='segmentID':
                ...
                source_vid=va_path+file_name+'.mp4'
