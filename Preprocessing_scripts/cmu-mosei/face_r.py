...
face_location = []
video_path = '/home/1TB/Preprocessing_MOSEI_NEW/clean_label_files/csd_labels/CMU-MultimodalSDK/New_Chunked_Data/valid/'
...
for video in video_list:
    ...
    if len(frame_list) != 0:
        print("writing",count)
        video = cv2.VideoWriter('/home/1TB/Preprocessing_MOSEI_NEW/clean_label_files/csd_labels/CMU-MultimodalSDK/New_Chunked_Data/FaceVideo/valid/' + video, fourcc, fps, (size, size))
