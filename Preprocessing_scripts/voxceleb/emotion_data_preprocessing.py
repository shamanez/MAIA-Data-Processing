    ...
    def preprocess_data(self , video_path, audio_path, text_path):
        ...
        if text_path:
            ...
            for root,dirs,files in os.walk(text_path):
                text_files += [os.path.join(root,f) for f in files if f.endswith(".txt")]
            ...
            for text_file in text_files:
                ...
                output_file = text_file.replace('text_raw','text')#.replace('.txt','.pt')
        ...
        if audio_path:
            ...
            for audio_file in audio_files:
                ...
                output_file = audio_file.replace('audio_raw','audio').replace('.wav','.pt')
                os.makedirs(os.path.dirname(output_file), exist_ok=True)
...
if __name__ == "__main__":
    ...
    audio_path = './final/augmented_raw/audio_raw/'
    #text_path = './final/text_raw/'
